...
function DeleteUser(){
    ...
    return(
        ...
        <div className="bg-[#242B58]  h-[50px] flex pl-4 items-center max-[571px]:h-[40px]">
                  <h1 className="text-white font-bold text-xl">Delete account</h1>
              </div>
              <div className="flex shadow-sm items-center flex-col pt-[50px]  pb-[50px]">
                <h1 className="pl-4 text-start w-[80%]">Plaese enter a password for continue</h1>
